...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        \
        luci-app-amlogic luci-i18n-amlogic-zh-cn luci-app-filebrowser luci-i18n-filebrowser-zh-cn luci-theme-argon lucky luci-app-lucky luci-i18n-lucky-zh-cn luci-app-oaf luci-i18n-oaf-zh-cn \
        \
        ${config_list} \
        "
